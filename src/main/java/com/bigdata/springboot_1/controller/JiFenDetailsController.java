...
import com.bigdata.springboot_1.mapper.JiFenDetailsMapper;
import com.bigdata.springboot_1.pojo.JiFenDetails;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;

@RestController
public class JiFenDetailsController {
	@Autowired JiFenDetailsMapper jifendetailsmapper;
	@RequestMapping("/listjifendetails") 
...
//	当没有使用@RequestMapping标记类时，方法的请求地址是绝对路径。
	public 	PageInfo<JiFenDetails> listCategory(
		...
		List<JiFenDetails> ur= jifendetailsmapper.findall();
		PageInfo<JiFenDetails> page = new PageInfo<>(ur);
		return page;
	}
}
