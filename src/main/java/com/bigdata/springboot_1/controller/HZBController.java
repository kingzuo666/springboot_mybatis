...
import com.bigdata.springboot_1.mapper.HZBMapper;
import com.bigdata.springboot_1.pojo.HZB;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;

@RestController
public class HZBController {
	@Autowired HZBMapper hzbmapper;
	@RequestMapping("/listhzb") 
...
//	当没有使用@RequestMapping标记类时，方法的请求地址是绝对路径。
	public 	PageInfo<HZB> listCategory(
		...
		List<HZB> ur=hzbmapper.findall();
		PageInfo<HZB> page = new PageInfo<>(ur);
		return page;
	}
}
