...
import com.bigdata.springboot_1.mapper.PyDetailsMapper;
import com.bigdata.springboot_1.pojo.PyDetails;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;

@RestController
public class PyDetailsController {
	@Autowired PyDetailsMapper pydetailsmapper;
	@RequestMapping("/listpydetails") 
...
//	当没有使用@RequestMapping标记类时，方法的请求地址是绝对路径。
	public 	PageInfo<PyDetails> listCategory(
		...
		List<PyDetails> ur= pydetailsmapper.findall();
		PageInfo<PyDetails> page = new PageInfo<>(ur);
		return page;
	}
}
